...
public class CustomerController {
	...
	@PutMapping("stateActive/{code}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public ResponseEntity<CustomerDTO> handleActive(@PathVariable Long code) {
        CustomerDTO objDTO = new CustomerDTO (service.stateActive(code));
